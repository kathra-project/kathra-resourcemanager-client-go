...
// WithResourceID adds the resourceID to the delete group params
func (o *DeleteGroupParams) WithResourceID(resourceID string) *DeleteGroupParams {
	o.SetResourceID(resourceID)
	return o
}

// SetResourceID adds the resourceId to the delete group params
func (o *DeleteGroupParams) SetResourceID(resourceID string) {

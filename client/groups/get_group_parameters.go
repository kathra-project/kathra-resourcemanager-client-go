...
// WithResourceID adds the resourceID to the get group params
func (o *GetGroupParams) WithResourceID(resourceID string) *GetGroupParams {
	o.SetResourceID(resourceID)
	return o
}

// SetResourceID adds the resourceId to the get group params
func (o *GetGroupParams) SetResourceID(resourceID string) {

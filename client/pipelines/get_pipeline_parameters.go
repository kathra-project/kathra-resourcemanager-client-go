...
// WithResourceID adds the resourceID to the get pipeline params
func (o *GetPipelineParams) WithResourceID(resourceID string) *GetPipelineParams {
	o.SetResourceID(resourceID)
	return o
}

// SetResourceID adds the resourceId to the get pipeline params
func (o *GetPipelineParams) SetResourceID(resourceID string) {

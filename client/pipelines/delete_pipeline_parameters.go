...
// WithResourceID adds the resourceID to the delete pipeline params
func (o *DeletePipelineParams) WithResourceID(resourceID string) *DeletePipelineParams {
	o.SetResourceID(resourceID)
	return o
}

// SetResourceID adds the resourceId to the delete pipeline params
func (o *DeletePipelineParams) SetResourceID(resourceID string) {

...
// Default kathra resource manager HTTP client.
...
// NewHTTPClient creates a new kathra resource manager HTTP client.
func NewHTTPClient(formats strfmt.Registry) *KathraResourceManager {
	return NewHTTPClientWithConfig(formats, nil)
}

// NewHTTPClientWithConfig creates a new kathra resource manager HTTP client,
// using a customizable transport config.
func NewHTTPClientWithConfig(formats strfmt.Registry, cfg *TransportConfig) *KathraResourceManager {
...
// New creates a new kathra resource manager client
func New(transport runtime.ClientTransport, formats strfmt.Registry) *KathraResourceManager {
	// ensure nullable parameters have default
	if formats == nil {
		formats = strfmt.Default
	}

	cli := new(KathraResourceManager)
...
// KathraResourceManager is a client for kathra resource manager
type KathraResourceManager struct {
...
func (c *KathraResourceManager) SetTransport(transport runtime.ClientTransport) {

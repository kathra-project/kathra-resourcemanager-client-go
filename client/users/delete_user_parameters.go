...
// WithResourceID adds the resourceID to the delete user params
func (o *DeleteUserParams) WithResourceID(resourceID string) *DeleteUserParams {
	o.SetResourceID(resourceID)
	return o
}

// SetResourceID adds the resourceId to the delete user params
func (o *DeleteUserParams) SetResourceID(resourceID string) {
